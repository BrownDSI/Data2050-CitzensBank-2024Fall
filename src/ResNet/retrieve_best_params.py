...
entity = "yi_sun1-brown-university"  # Replace with your W&B username or team name
project_name = "ResNet-MiddleDataSet" # Replace with your project name
sweep_id = "d0b737wb"  # Replace with your actual sweep ID
