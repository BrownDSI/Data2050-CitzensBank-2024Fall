...
if __name__ == "__main__":
    ...
    triplets_path = os.path.abspath("../preprocessing/preprocessed_dataset/preprocessed/ResNet/preprocessed_triplets.npy")
    ...
    sweep_id = wandb.sweep(sweep_config, project="ResNet-MiddleDataSet")
