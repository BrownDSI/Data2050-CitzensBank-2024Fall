...
entity = "maruize7-brown-university"  # Replace with your W&B username or team name
project_name = "VGG16" # Replace with your project name
sweep_id = "dxexr552"  # Replace with your actual sweep ID
