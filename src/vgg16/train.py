...
# triplets_path = os.path.abspath(os.path.join(current_dir, '..', '..', 'preprocessed_triplets.npy'))
triplets_path = os.path.abspath("../preprocessing/preprocessed_dataset/preprocessed/VGG16/preprocessed_triplets.npy")
...
#study.optimize(objective, n_trials=2) # testing
