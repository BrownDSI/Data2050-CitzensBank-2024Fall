...
def objective():
    ...
    criterion = TripletLoss(config.margin).to(device)
...
if __name__ == "__main__":
    ...
    triplets_path = os.path.abspath(r"C:\Users\marui\Brown\DATA2050\CitizensBank-Fraud-Signature-Detection\src\preprocessing\preprocessed_dataset\preprocessed\VGG_small\preprocessed_triplets.npy")
